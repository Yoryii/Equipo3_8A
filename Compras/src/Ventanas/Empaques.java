  ...
  txfCapacidad.setEditable(txfNombre.getText().length() != 0);
    ...
    public void cargarTabla() {
        ...
        try {
            ...
            ps = con.prepareStatement("SELECT idEmpaque, nombre, capacidad, estatus FROM Empaques WHERE estatus = 'A' ORDER BY idEmpaque ASC OFFSET ? ROWS FETCH NEXT ? ROWS ONLY");
            ps.setInt(1, rango);
